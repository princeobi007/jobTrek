package com.ihechi.jobTrek.config;

import com.ihechi.jobTrek.security.JwtAuthenticationFilter;
...
public class SecurityConfig {
  ...
  public AuthenticationManager authenticationManager(AuthenticationConfiguration config) throws Exception {
    return config.getAuthenticationManager(); // Use default Spring Security setup
  }
